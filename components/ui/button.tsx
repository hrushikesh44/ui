...
export function Button({ name , icon} : ButtonProps){
    return(
        <button className="flex items-center justify-center w-full px-2 py-1 rounded shadow-[0_0.5px_1px_rgb(0,0,0,0.2)] border border-neutral-400/10 inset-shadow-2xs hover:bg-neutral-200/50 cursor-pointer gap-3">{name}{icon}</button>
    )
}
